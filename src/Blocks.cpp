...
LBlock::LBlock() {
    ...
    blockColor = COLORS[id]; // Couleur du bloc L
    ...
    Move(0, 3); // Positionnement initial du bloc dans la grille
}

JBlock::JBlock() {
    id = 2; // ID pour le bloc J
    blockColor = COLORS[id]; // Couleur du bloc J
    currentRotation = 0; // Rotation initiale
...
IBlock::IBlock() {
    ...
    Move(-1, 3); // Positionnement initial du bloc dans la grille
}

OBlock::OBlock() {
    id = 4; // ID pour le bloc O
    blockColor = COLORS[id]; // Couleur du bloc O
    ...
    Move(0, 4); // Positionnement initial du bloc dans la grille
}

SBlock::SBlock() {
    id = 5; // ID pour le bloc S
    blockColor = COLORS[id]; // Couleur du bloc S
    currentRotation = 0; // Rotation initiale
...
TBlock::TBlock() {
    ...
    blockColor = COLORS[id]; // Couleur du bloc T
    currentRotation = 0; // Rotation initiale
...
ZBlock::ZBlock() {
    ...
    blockColor = COLORS[id]; // Couleur du bloc Z
    currentRotation = 0; // Rotation initiale
