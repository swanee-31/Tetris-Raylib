...
static const int GRID_ROWS = 20; // Nombre de lignes dans la grille
static const int GRID_COLS = 10; // Nombre de colonnes dans la grille
...
static const char* GAME_TITLE = "Tetris with Raylib"; // Titre de la fenêtre du jeu
static const int TARGET_FPS = 60;
static const Color BACKGROUND_COLOR = GRAY;
static double MOVE_INTERVAL = 0.3; // Intervalle de temps (en secondes) entre les mouvements automatiques du bloc vers le bas
